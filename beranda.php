  ...
  <section class="bg-gradient-to-r from-green-150 to-green-100 py-16 fade-in-up">
    <div class="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center justify-between gap-8">
      ...
      <div class="md:w-1/2 text-center md:text-left">
        ...
        <a href="pemesan-tiket.php"
           class="inline-block bg-green-700 hover:bg-green-800 text-white px-6 py-3 rounded-lg font-semibold shadow transition">
    ...
    <div class="container mx-auto px-6">
      ...
      <form action="hasil-pencarian.php" method="GET" class="bg-white p-8 rounded-lg shadow max-w-5xl mx-auto space-y-6">
        ...
        <div class="flex justify-center gap-4">
          <button type="button" class="bg-green-200 text-green-700 px-4 py-2 rounded-full text-sm">Hari Ini</button>
          <button type="button" class="bg-green-200 text-green-700 px-4 py-2 rounded-full text-sm">Besok</button>
        </div>
